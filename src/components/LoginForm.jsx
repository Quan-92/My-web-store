...
class App extends Component {
    ...
    componentDidMount() {
        ...
        function calculateFaceMove(e) {
            {
                ...
                if (carPos === null || carPos === 0) {
                    // if browser doesn't support 'selectionEnd' property on input[type="name"], use 'value.length' property instead
                ...
                if (name.scrollWidth <= nameScrollMax) {
                    ...
                    eyeLAngle = getAngle(eyeLCoords.x, eyeLCoords.y, nameCoords.x + caretCoords.x, nameCoords.y + 25);
                    eyeRAngle = getAngle(eyeRCoords.x, eyeRCoords.y, nameCoords.x + caretCoords.x, nameCoords.y + 25);
                    noseAngle = getAngle(noseCoords.x, noseCoords.y, nameCoords.x + caretCoords.x, nameCoords.y + 25);
                    mouthAngle = getAngle(mouthCoords.x, mouthCoords.y, nameCoords.x + caretCoords.x, nameCoords.y + 25);
                } else {
                    eyeLAngle = getAngle(eyeLCoords.x, eyeLCoords.y, nameCoords.x + nameScrollMax, nameCoords.y + 25);
                    eyeRAngle = getAngle(eyeRCoords.x, eyeRCoords.y, nameCoords.x + nameScrollMax, nameCoords.y + 25);
                    noseAngle = getAngle(noseCoords.x, noseCoords.y, nameCoords.x + nameScrollMax, nameCoords.y + 25);
                    mouthAngle = getAngle(mouthCoords.x, mouthCoords.y, nameCoords.x + nameScrollMax, nameCoords.y + 25);
                }
        ...
        function initLoginForm() {
            ...
            nameLabel.addEventListener('click', onNameLabelClick);
            ...
            // determine how far name input can go before scrolling occurs
            ...
            <div className="App">
                <form>
                        ...
                        <div>
                            <svg className="mySVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
                                ...
                                <g className="eyebrow">
                                    ...
                                    <path fill="#FFFFFF" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M63.56,55.102 c6.243,0.624,18.38,10.614,21.296,14.738c2.071-2.785,4.01-5.626,5.816-8.515c4.537,3.785,9.583,7.263,15.097,10.329 c1.197-3.043,2.287-6.104,3.267-9.179c4.087,2.004,8.427,3.761,12.996,5.226c0.545-3.348,0.986-6.696,1.322-10.037 c4.913-0.481,9.857-1.34,14.787-2.599" />
                                </g>
                                <g className="eyeL">
                    ...
                    <div className="inputGroup inputGroup1">
                        <label for="loginName" id="loginNameLabel">Name</label>
                        <input type="name" id="loginName" maxlength="254" />
